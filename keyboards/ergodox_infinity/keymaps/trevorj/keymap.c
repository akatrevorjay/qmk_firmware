/* Copyright 2016-2018 Trevor Joynson
 *
...
/* void dance_flsh_each__to_layer(qk_tap_dance_state_t *state, void *user_data) { */
...
/*     #<{(| [TD_LTOG] = ACTION_LAYER_TAP_TOGGLE(SYMB), |)}># */
/*     [TD_TOLAYER] = */
/*         ACTION_TAP_DANCE_FN_ADVANCED(dance_flsh_each__to_layer, NULL, NULL), */
/*     #<{(| [TD_GRR] = ACTION_TAP_DANCE_FN_ADVANCED (dance_flsh_each, */
/*        dance_flsh_finished, dance_flsh_reset) |)}># */
...
const uint16_t PROGMEM fn_actions[] = {
    [0] = ACTION_LAYER_TAP_KEY(
        FNMM, KC_GRV), // FN0 - Momentary Layer 1 or tap for grave/tilde
    [1] = ACTION_LAYER_TAP_TOGGLE(
        FNMM), // FN1 - Momentary Layer 1 or tap to toggle
...
/*const macro_t *action_get_macro(keyrecord_t *record, uint8_t id, uint8_t
 * opt)*/
/*{ */
